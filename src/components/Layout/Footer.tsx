        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-agence-gray-700 flex items-center justify-center transition-colors hover:bg-agence-orange-500">
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-agence-gray-300">
                  123 Avenue des Cuisinistes, 75000 Paris, France
                </span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-agence-gray-300">contact@agencemoi.fr</span>
              </li>
            </ul>
            <div className="mt-8">
