        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-agence-gray-700">
              ...
              <p>
                Pour toute question concernant les présentes conditions générales, veuillez nous contacter à l'adresse suivante : 123.agencemoi@gmail.com ou par téléphone au 06.61.46.16.81.
              </p>
            </div>
          </div>
        </div>
